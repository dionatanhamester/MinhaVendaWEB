<%-- 
    ...
    Created on : 04/06/2017, 20:29:36
    Author     : Dionatan
--%>

<%@include file="default/header.jsp" %>		
<div class="header">
    <p> <i class="fa fa-database fa-2x" aria-hidden="true"> </i> Produtos</p> 
</div>
        ...
        <tbody>
            ...
            <tr>	    		
                <td align="right" colspan="4">
                    <a href="cadastro_produtos.jsp"><button class="button-success" id="adicionar">Adicionar <i class="fa fa-plus" aria-hidden="true"></i></button></a>
