<div class="left">
    ...
    <div id="navbarleft">         
        <ul>
            ...
            <li><a href="<%=request.getContextPath()%>/lista_formaspgto.jsp"><i class="fa fa-google-wallet" aria-hidden="true"> </i> Formas de Pgto</a></li>           
            <li><a href="<%=request.getContextPath()%>/lista_tabelaprecos.jsp"><i class="fa fa-table" aria-hidden="true"> </i> Tabela de Preços</a></li>           
            <li><a href="<%=request.getContextPath()%>/lista_pedidos.jsp"><i class="fa fa-tags" aria-hidden="true"> </i> Pedidos</a></li>           
            <li><a href="<%=request.getContextPath()%>/lista_usuarios.jsp"><i class="fa fa-users" aria-hidden="true"> </i> Usuários</a></li>           
            <br><br>
